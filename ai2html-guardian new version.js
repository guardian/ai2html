...
// MAIN GUARDIAN CUSTOM CODE
  ...
  function addCustomGuardianContent(content, settings) {
    ...
    content.css += "@media (prefers-color-scheme: light) {\r";
    content.css += "\t\t.dark-mode-ready .artboard-dark-mode {\r";
    content.css += "\t\t\tdisplay: none !important;\r";
    content.css += "\t\t}\r";
    content.css += "\t\t}\r";
    ...
    // White text outline
    content.css += "\t\t." + nameSpace + "white-outlined-text p {\r";
    content.css += "\t\t\ttext-shadow: 1px 1px 0 #FFF, -1px -1px 0 #FFF, 1px -1px 0 #FFF, -1px  1px 0 #FFF, 1px  1px 0 #FFF;\r";
    content.css += "\t\t}\r";

    // White text outline thicker
    content.css += "\t\t." + nameSpace + "white-outlined-text-thicker p {\r";
    ...
    content.css += "\t\t\tpadding: 4px;\r";
    content.css += "\t\t\tmargin: -4px 0 0 -4px;\r";
    content.css += "}\t\t\r";

    // Basic text shadow 
    content.css += "\t\t." + nameSpace + "shadow p {\r";
    content.css += "\t\t\ttext-shadow: 0px 0px 20px rgba(0, 0, 0, 0.9);\r";
    content.css += "\t\t}\r";
