...
var defaultBaseSettings = {
  ...
  output: {defaultValue: "one-file", includeInSettingsBlock: true, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "text", possibleValues: "one-file, multiple-files, multiple-steps", notes: "One html file containing all the artboards, a separate html file for each artboard, or for use in a stepper, a separate file for each step across all breakpoints"},
  project_name: {defaultValue: "", includeInSettingsBlock: false, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "text", possibleValues: "", notes: "Use this to set a custom project name. The project name is being used in output filenames, class names, etc."},
...
var guardianBaseSettings = {
  ...
  image_format: {defaultValue: ["png"], includeInSettingsBlock: true, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "array", possibleValues: "jpg, png, png24", notes: "Images will be generated in mulitple formats if multiple formats are listed, separated by commas. The first format will be used in the html. Sometimes this is useful to compare which format will have a smaller file size."},
  write_image_files: {defaultValue: "yes", includeInSettingsBlock: false, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "yesNo", possibleValues: "", notes: "Set this to \u201Cno\u201D to skip writing the image files. Generally only use this after you have run the script once with this setting set to \u201Cyes.\u201D"},
  responsiveness: {defaultValue: "dynamic", includeInSettingsBlock: true, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "text", possibleValues: "fixed, dynamic, fixed-all", notes: "Dynamic responsiveness means ai graphics will scale to fill the container they are placed in."},
  ...
  top_and_bottom_rules: {defaultValue: "true", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "trueFalse", possibleValues: "", notes: ""},
  main_background_color: {defaultValue: "#ffffff", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "text", possibleValues: "", notes: ""},
  // force_transparent_background: {defaultValue: "false", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "text", possibleValues: "", notes: ""},
...
output_no_headline_visual_guide: {defaultValue: "no", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: false, inputType: "yesNo", possibleValues: "", notes: "Set this to “yes” if you want to create a second html file with headline removed for a Visual Guide"},
  add_headline_source_wrapper: {defaultValue: "no", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: false, inputType: "yesNo", possibleValues: "", notes: "Set this to “yes” if you want to automatically add a headline, source etc in the standard graphics style. This will be created from the following headline, standfirst, source_left and source_right values"},
    ...
    immersive_padding_fix: {defaultValue: "false", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "trueFalse", possibleValues: "", notes: "Adds left padding fix to graphics with immersive weighting in Composer on mobile viewports"},
...
// guFontsCss += "@font-face{font-family:'Guardian Text Egyptian Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Text Egyptian Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-RegularItalic.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-RegularItalic.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-RegularItalic.ttf) format('truetype');font-weight:400;font-style:italic;font-stretch:normal}@font-face{font-family:'Guardian Text Egyptian Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Medium.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Medium.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textegyptian/GuardianTextEgyptian-Medium.ttf) format('truetype');font-weight:700;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Egyptian Web';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Light.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Light.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Light.ttf) format('truetype');font-weight:200;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Egyptian Web';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Egyptian Web';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Medium.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Medium.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Medium.ttf) format('truetype');font-weight:500;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Egyptian Web';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Semibold.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Semibold.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianEgyptianWeb/GuardianEgyptianWeb-Semibold.ttf) format('truetype');font-weight:900;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Text Sans Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Text Sans Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-RegularItalic.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-RegularItalic.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-RegularItalic.ttf) format('truetype');font-weight:400;font-style:italic;font-stretch:normal}@font-face{font-family:'Guardian Text Sans Web';url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Medium.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Medium.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/sep2018/noalts_not_hinted_webmetrics/textsans/GuardianTextSans-Medium.ttf) format('truetype');font-weight:700;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Sans Web';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianSansWeb/GuardianSansWeb-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianSansWeb/GuardianSansWeb-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianSansWeb/GuardianSansWeb-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Agate Sans';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Agate Sans';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-RegularItalic.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-RegularItalic.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-RegularItalic.ttf) format('truetype');font-weight:400;font-style:italic;font-stretch:normal}@font-face{font-family:'Guardian Agate Sans';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Bold.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Bold.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-Bold.ttf) format('truetype');font-weight:700;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Agate Sans';url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-BoldItalic.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-BoldItalic.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GuardianAgateSans1Web/GuardianAgateSans1Web-BoldItalic.ttf) format('truetype');font-weight:700;font-style:italic;font-stretch:normal}@font-face{font-family:'GH Guardian Headline';src:url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Bold.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Bold.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Bold.ttf) format('truetype');font-weight:700;font-style:normal;font-stretch:normal}@font-face{font-family:'GH Guardian Headline';src:url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Regular.woff2) format('woff2'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Regular.woff) format('woff'),url(https://interactive.guim.co.uk/fonts/guss-webfonts/GHGuardianHeadline/GHGuardianHeadline-Regular.ttf) format('truetype');font-weight:400;font-style:normal;font-stretch:normal}@font-face{font-family:'Guardian Titlepiece';url('https://interactive.guim.co.uk/fonts/garnett/GTGuardianTitlepiece-Bold.woff2') format('woff2'),url('https://interactive.guim.co.uk/fonts/garnett/GTGuardianTitlepiece-Bold.woff') format('woff'),url('https://interactive.guim.co.uk/fonts/garnett/GTGuardianTitlepiece-Bold.ttf') format('truetype');font-weight:700;font-style:normal}";
...
//var superString = "";
  ...
  function customGuardianGraphicsCss() {
    ...
    //cggCss += "\t\tbody {\r";
    //cggCss += "\t\t\tbackground-color:#ffffff;\r";
    //cggCss += "\t\t}\r";
    
    // cggCss += "\t\tbody.force-transparent-background_true {\r";
    // cggCss += "\t\t\tbackground-color:transparent!important;\r";
    // cggCss += "\t\t}\r";
    

    cggCss += "\t\t.not-in-app .artboard-dark-mode {\r";
    cggCss += "\t\t\tdisplay: none !important;\r";
    cggCss += "\t\t}\r";

    cggCss += "@media (prefers-color-scheme: dark) {\r";
    cggCss += "\t\t.dark-mode-ready .artboard-light-mode {\r";
    cggCss += "\t\t\tdisplay: none !important;\r";
    cggCss += "\t\t}\r";
    cggCss += "\t\t}\r";
    
    cggCss += "@media (prefers-color-scheme: light) {\r";
    cggCss += "\t\t.dark-mode-ready .artboard-dark-mode {\r";
    cggCss += "\t\t\tdisplay: none !important;\r";
    cggCss += "\t\t}\r";
    cggCss += "\t\t}\r";  

    cggCss += "\t\tbody.use-rules_true {\r";
    cggCss += "\t\t\tborder-top:1px solid #dcdcdc;\r";
    cggCss += "\t\t\tborder-bottom:1px solid #dcdcdc;\r";
    cggCss += "\t\t}\r"; 
    ...
    cggCss += "}\t\r";
     ...
     // White ragged background text 
     cggCss += "\t\t." + nameSpace + "white-ragged-background-text p {\r";
     // customGuardianGraphicsCss += "\t-webkit-text-stroke: 1px white;\r"; //overkill
     cggCss += "\t\t\tbackground-color: #FFF;\r";
     cggCss += "\t\t\tpadding: 6px;\r";
     cggCss += "\t\t\tdisplay: inline-block;\r";
     //cggCss += "\t\t\tmargin: -4px 0 0 -4px;\r";
     cggCss += "}\t\r";

       // Black ragged background text 
       cggCss += "\t\t." + nameSpace + "black-ragged-background-text p {\r";
       // customGuardianGraphicsCss += "\t-webkit-text-stroke: 1px white;\r"; //overkill
       cggCss += "\t\t\tbackground-color: #121212;\r";
       cggCss += "\t\t\tpadding: 6px;\r";
       cggCss += "\t\t\tdisplay: inline-block;\r";
       //cggCss += "\t\t\tmargin: -4px 0 0 -4px;\r";
       cggCss += "}\t\r";

    cggCss += "\t\t." + nameSpace + "shadow p {\r";
    cggCss += "\t\t\ttext-shadow: 0px 0px 20px rgba(0, 0, 0, 0.9);\r";
    cggCss += "\t\t}\r";

    cggCss += "\t\t." + nameSpace + "glow p {\r";
    cggCss += "\t\t\ttext-shadow: 0px 0px 20px rgba(255, 255, 255, 0.9);\r";
    cggCss += "\t\t}\r";
...
// Partial html for standard Guardian graphics iframe template
  ...
  function addIframeHtml(position) {
    ...
    iframeHeaderPartial += "@media (prefers-color-scheme: dark) {\r";
    iframeHeaderPartial += "\t\tbody.dark-mode-ready {\r";
    iframeHeaderPartial += "\t\t\tbackground-color: #1A1A1A !important;\r";
    iframeHeaderPartial += "\t\t}\r";
    iframeHeaderPartial += "\t\t}\r";
    iframeHeaderPartial += "</style>\r";

    iframeHeaderPartial += "</head>\r";
    iframeHeaderPartial += "<body class='use-rules_" + docSettings.top_and_bottom_rules + " immersive-padding-fix_" + docSettings.immersive_padding_fix + " not-in-app' style='background-color:" + docSettings.main_background_color + ";'>\r";
    ...
    iframeFooterPartial += "<script>iframeMessenger.enableAutoResize();\r";
    iframeFooterPartial += "iframeMessenger.getLocation(checkApp);\r";

    iframeFooterPartial += "function checkApp(locationObj) {\r";
    iframeFooterPartial += "var isIOS = /(iPad|iPhone|iPod touch)/i.test(navigator.userAgent);\r";
    iframeFooterPartial += "var isAndroid = /Android/i.test(navigator.userAgent);\r";
    iframeFooterPartial += "var isIOSApp = (isIOS && (locationObj.protocol === 'file://' || locationObj.protocol === 'file:')) ? true : false;\r";
    iframeFooterPartial += "var isAndroidApp = (isAndroid && (locationObj.protocol === 'file://' || locationObj.protocol === 'file:')) ? true : false;\r";
    iframeFooterPartial += "var isApp = isIOSApp || isAndroidApp;\r";
    iframeFooterPartial += "var darkModeArtboardsPresent = document.querySelector('.artboard-dark-mode') !== null;\r";
    iframeFooterPartial += "if (isApp) {\r";
    iframeFooterPartial += "document.querySelector('body').classList.remove('not-in-app');\r";
    iframeFooterPartial += "document.querySelector('body').classList.add('in-app');\r";
    iframeFooterPartial += "}\r";
    iframeFooterPartial += "if (isApp && darkModeArtboardsPresent) {\r";
    iframeFooterPartial += "document.querySelector('body').classList.add('dark-mode-ready');\r";
    iframeFooterPartial += "}\r";
    iframeFooterPartial += "}\r";

    iframeFooterPartial += "</script>\r";
...
// Partial html for standard Guardian graphics headline and source
  ...
  function addHeadlineSourceHtml(position) {
    ...
    //headerPartial += "\tborder-top:1px solid #dcdcdc;\r";
    headerPartial += "}\r";
    headerPartial += "." + nameSpace + "graphic-header h1 {\r";
    headerPartial += "\tpadding:6px 0 10px 0;\r"; // was 25px
    headerPartial += "\tmargin:0;\r";
    headerPartial += "\tfont-family:'GH Guardian Headline', Georgia, serif;\r";
    headerPartial += "\tfont-size:18px;\r";
    headerPartial += "\tfont-weight:700;\r";
    headerPartial += "\tline-height: 22px;\r";
    headerPartial += "\tcolor: #121212;\r"; // was #3333
    headerPartial += "}\r";
    ...
    headerPartial += "\tmargin:0;\r";
    headerPartial += "\tfont-family:'Guardian Text Egyptian Web', Georgia, serif;\r";
    headerPartial += "\tfont-size:14px;\r";
    headerPartial += "\tfont-weight:200;\r";
    headerPartial += "\tline-height: 18px;\r";
    headerPartial += "\tcolor: #121212;\r";
    headerPartial += "}\r";
    ...
    headerPartial += "\t\t.dark-mode-ready ." + nameSpace + "graphic-header h1 {\r";
    headerPartial += "\tcolor: #fff;\r";
    headerPartial += "\t\t}\r";
    headerPartial += "\t\t.dark-mode-ready ." + nameSpace + "graphic-header h2 {\r";
    headerPartial += "\tcolor: #fff;\r";
    headerPartial += "\t\t}\r";
    headerPartial += "\t\t}\r";
    ...
    var footerPartial = "";
    footerPartial += "<style>";
    footerPartial += "." + nameSpace + "graphic-footer {\r";
    footerPartial += "\tposition:relative;\r";
    footerPartial += "\theight:auto;\r";
    //headerPartial += "\tborder-top:1px solid #dcdcdc;\r";
    footerPartial += "\tmargin-top:0;\r";
    footerPartial += "}\r";
    footerPartial += " ." + nameSpace + "graphic-footer p {\r";
    footerPartial += "\tpadding:6px 0 6px 0;\r";
    footerPartial += "\tmargin:0;\r";
    footerPartial += "\tfont-family:'Guardian Text Sans Web', Arial, sans-serif;\r";
    footerPartial += "\tfont-size:12px;\r";
    footerPartial += "\tline-height: 15px;\r";
    footerPartial += "\tcolor: #767676;\r";
    footerPartial += "\tdisplay: inline-block;\r";
    //headerPartial += "\tborder-top:1px solid #dcdcdc;\r";
    footerPartial += "\twidth:100%;\r";
    footerPartial += "}\r";
    //headerPartial += "." + nameSpace + "graphic-footer p:nth-of-type(2) {\r";
    //headerPartial += "\tfloat:right;\r";
    //headerPartial += "}\r";
    footerPartial += "@media (prefers-color-scheme: dark) {\r";
    footerPartial += ".dark-mode-ready ." + nameSpace + "graphic-footer p {\r";
    footerPartial += "\tcolor: #dcdcdc;\r";
    footerPartial += "\t\t}\r";
    footerPartial += "\t\t}\r";

    footerPartial += "</style>\r";
...
function render() {
  ...
  forEachUsableArtboard(function(activeArtboard, abNumber) {
    ...
    //=====================================
      ...
      //=====================================
    // output html file here if doing a file for every step
    //=====================================

    if (docSettings.output=="multiple-steps") {

      var splitNameArray = getArtboardName(activeArtboard).split("_");
      var splitNameIndex = +splitNameArray[splitNameArray.length-1];
      if (typeof (splitNameIndex) == 'number') {
        var mqCss = generateMediaQueryCss();
        artboardContent +=
        "\r\t<!-- Artboard: " + getArtboardName(activeArtboard) + " -->\r<div class='gv-step gv-step_" + splitNameIndex + "'>" +
        ...
        textData.html +
        "\t</div></div>\r";
        //generateOutputHtml(addCustomContent(artboardContent, customBlocks), docName + "_step_" + splitNameIndex, docSettings, mqCss);
      }
    } else {
    artboardContent +=
  ...
  if (docSettings.output=="one-file" || docSettings.output=="multiple-steps") {
    var mqCss = generateMediaQueryCss();
...
function getCharStyle(c) {
  ...
  if (c.baselinePosition == 'FontBaselineOption.SUPERSCRIPT') {
    o.baseline = "superscript";
  } else if (c.baselinePosition == 'FontBaselineOption.SUBSCRIPT') {
    o.baseline = "subscript";
  }
  // superString += o.baseline + " ";
  // superString += c.openTypePosition + " ";
  // for (var key in c) {
...
function generateParagraphHtml(pData, baseStyle, pStyles, cStyles) {
  ...
  for (var j=0; j<pData.ranges.length; j++) {
    ...
    if (diff) {
      ...
      if (diff["vertical-align"] == "super") {
        html += '<sup>';
      }
      if (diff["vertical-align"] == "sub") {
        html += '<sub>';
      }
    }
...
function convertAiTextStyle(aiStyle) {
  ...
  if (aiStyle.baseline == "superscript") {
    // cssStyle["font-size"] = Number(aiStyle.size) * 0.6 + "px";
    cssStyle["vertical-align"] = "super";
  } else if (aiStyle.baseline == "subscript") {
    // cssStyle["font-size"] = Number(aiStyle.size) * 0.6 + "px";
  ...
  // if ('superscript' in aiStyle) {
  //   superString += "___YES_SUPER";
...
function getTextFrameCss(thisFrame, abBox, pgData) {
  ...
  if (alignment == "right") {
    ...
    // styles += "left:" + formatCssPct(htmlL + htmlBox.width/ 2, abBox.width); // OLD
    // styles += "margin-left:" + formatCssPct(-htmlW / 2, abBox.width); // OLD
...
function getOutputImagePixelRatio(width, height, format, doubleres) {
  ...
  if (doubleres == "yes" && width < 620) { // assume wide images are desktop-only
...
function exportImageFiles(dest, ab, formats, initialScaling, doubleres) {
  ...
  forEach(formats, function(format) {
    ...
    if (isTrue(docSettings.png_transparent && format=="png")) {
      format="png24"; // Force 24 bit for transparent pngs
    }
    ...
    if (format=="png") {
      ...
      // if(isTrue(docSettings.force_transparent_background)) {
...
function generateArtboardDiv(ab, breakpoints, settings) {
  ...
  var isDarkModeArtboard = divId.indexOf("_dark-mode") !== -1;
  var classnames = nameSpace + "artboard " + nameSpace + "artboard-v3";
  if (isDarkModeArtboard) {
    classnames += " artboard-dark-mode";
  } else {
    classnames += " artboard-light-mode";
  }
...
function generateArtboardCss(ab, textClasses, settings, ind) {
  ...
  var smallestWidth = sortedArtboards[0].width;
  var thisWidth = convertAiBounds(ab.artboardRect).width;
  
  if (settings.responsiveness=="fixed" && thisWidth != smallestWidth) { // responsive only with first artboards on this setting
    css += t4 + "width:"  + thisWidth + "px;\r";
  }
  if (settings.responsiveness=="fixed-all") { // fixed for every artboard
    css += t4 + "width:"  + thisWidth + "px;\r";
  }
  //alert(settings.responsiveness);
  css += t3 + "}\r";
...
var css = "", infoArr, ab, abW, lastWidth = null, newWidth;
...
for(var abIndex = 0; abIndex < infoArr.length; abIndex ++) {
      newWidth = Number(infoArr[abIndex].width) -.5;
			if (abIndex > 0 && newWidth != lastWidth) {
				css += "\t\t@media (min-width: " + newWidth + "px) { \r";
			}
...
function generateOutputHtml(pageContent, pageName, settings, mqCss) {
  ...
  var textForFile = "", textForFileVG = "";
  var responsiveCss = "";
  var responsiveJs = "";
  var containerId = nameSpace + pageName + "-box";
  var htmlFileDestination, htmlFileDestinationVG, htmlFileDestinationFolder;
  var finalFolder;
...
// add media query breakpoint css
  ...
  if (isTrue(settings.embed_as_iframe)) {
      ...
      textForFileVG += addIframeHtml("header");
	}
  ...
  textToAdd += '<div id="' + containerId + '" class="ai2html">\r';

  textToAdd += "\t<!-- Generated by ai2html v" + scriptVersion + " - " + getDateTimeStamp() + " -->\r";
  textToAdd += "\t<!-- ai file: " + doc.name + " -->\r";
  if (scriptEnvironment == "nyt") {
    textToAdd += "\t<!-- preview: " + settings.preview_slug + " -->\r";
    textToAdd += "\t<!-- scoop  : " + settings.scoop_slug_from_config_yml + " -->\r";
  }
  textToAdd += generatePageCss(containerId, settings);

  if (linkSrc) {
    // optional link around content
    textToAdd += "\t<a class='" + nameSpace + "ai2htmlLink' href='" + linkSrc + "'>\r";
  }

  textToAdd += guFontsCss; // ADD GUARDIAN FONTS
  textToAdd += responsiveCss;
  textToAdd += pageContent;
  textToAdd += responsiveJs;
  ...
  // close <div> wrapper
  textToAdd += "\t<!-- End ai2html" + " - " + getDateTimeStamp() + " -->\r</div>\r";

  textForFile += textToAdd;
  textForFileVG += textToAdd;
	...
	if (isTrue(settings.add_headline_source_wrapper)) {
      ...
      textForFileVG += addHeadlineSourceHtml( "footer" );
	}

  if (isTrue(settings.embed_as_iframe)) {
			textForFile += addIframeHtml("footer");
      textForFileVG += addIframeHtml("footer");
	}

  textForFile = applyTemplate(textForFile, settings);
  textForFileVG = applyTemplate(textForFileVG, settings);
...
htmlFileDestination = htmlFileDestinationFolder + "index" + settings.html_output_extension;
  ...
  htmlFileDestinationVG = htmlFileDestinationFolder + "index_visual_guide" + settings.html_output_extension;
  ...
  if (isTrue(settings.output_no_headline_visual_guide)) {
  saveTextFile(htmlFileDestinationVG, textForFileVG); 
  }
