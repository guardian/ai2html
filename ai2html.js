...
var guardianBaseSettings = {
  ...
  top_and_bottom_rules: {defaultValue: "true", includeInSettingsBlock: true, includeInConfigFile: true, useQuoteMarksInConfigFile: true, inputType: "text", possibleValues: "", notes: ""},
...
// Partial html for standard Guardian graphics iframe template
  ...
  function addIframeHtml(position) {
    ...
    iframeHeaderPartial += "</head>\r";
    iframeHeaderPartial += "<body class='use-rules_" + docSettings.top_and_bottom_rules + "'>\r";
...
// Partial html for standard Guardian graphics headline and source
  ...
  function addHeadlineSourceHtml(position) {
    ...
    headerPartial += "\tmargin:0;\r";
    headerPartial += "\tfont-family:'Guardian Text Egyptian Web', Arial, sans-serif;\r";
